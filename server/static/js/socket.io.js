!(function(t, e) {
	typeof exports === 'object' && typeof module === 'object'
		...
		: typeof define === 'function' && define.amd
			? define([], e)
			: typeof exports === 'object' ? (exports.io = e()) : (t.io = e());
})(this, () => (function(t) {
	function e(r) {
	...
	function(t, e, n) {
		...
		function r(t, e) {
			(typeof t === 'undefined' ? 'undefined' : o(t)) === 'object' &&
					((e = t), (t = void 0)),
			(e = e || {});
			let n,
				r = i(t),
	...
	function(t, e, n) {
		...
		function o(t) {
			function n() {
				if (n.enabled) {
					...
					const c = n.log || e.log || console.log.bind(console);
					c.apply(t, i);
				}
			}
			return (
		...
		function i(t) {
			...
			for (
				let n = (typeof t === 'string' ? t : '').split(/[\s,]+/),
					r = n.length,
					o = 0;
				o < r;
				o++
	...
	function(t, e, n) {
		...
		function a(t) {
			...
			if (e.types[r.type] == null) return u();
	...
	function(t, e, n) {
		...
		(r.prototype.emit = function(t) {
			...
			if (n) {
				n = n.slice(0);
				for (let r = 0, o = n.length; r < o; ++r) n[r].apply(this, e);
			}
			return this;
		}),
	...
	function(t, e, n) {
		(function(e) {
			function r(t) {
				...
				if (o(t)) {
					for (let n = 0, i = t.length; n < i; n++) if (r(t[n])) return !0;
					return !1;
				}
				if (
					(typeof e.Buffer === 'function' &&
							e.Buffer.isBuffer &&
							e.Buffer.isBuffer(t)) ||
						(typeof e.ArrayBuffer === 'function' && t instanceof ArrayBuffer) ||
						(s && t instanceof Blob) ||
						(a && t instanceof File)
				)
					return !0;
			...
			var o = n(10),
				...
				s =
						...
						i.call(e.Blob) === '[object BlobConstructor]',
				a =
						typeof e.File === 'function' ||
						i.call(e.File) === '[object FileConstructor]';
			t.exports = r;
		}.call(
			e,
			(function() {
	...
	function(t, e, n) {
		(function(t) {
			...
			function o(t, e) {
				...
				if (i(t)) for (let n = 0; n < t.length; n++) t[n] = o(t[n], e);
				else if (typeof t === 'object') for (const r in t) t[r] = o(t[r], e);
				return t;
			}
			var i = n(10),
				s = n(12),
				...
				c =
						...
						a.call(t.Blob) === '[object BlobConstructor]',
				p =
						typeof t.File === 'function' ||
						a.call(t.File) === '[object FileConstructor]';
			...
			(e.removeBlobs = function(t, e) {
				function n(t, a, u) {
					...
					} else if (i(t)) for (let f = 0; f < t.length; f++) n(t[f], f, t);
					else if (typeof t === 'object' && !s(t))
						for (const l in t) n(t[l], l, t);
				}
				var r = 0,
					o = t;
				n(o), r || e(o);
	...
	function(t, e, n) {
		...
		(r.prototype.cleanup = function() {
			h('cleanup');
			for (let t = this.subs.length, e = 0; e < t; e++) {
		...
		(function(e) {
			function r(t, n) {
				...
				(this.secure =
							n.secure != null
								? n.secure
								: e.location && location.protocol === 'https:'),
										...
										if (!h)
											if (e.type === 'pong' && e.data === 'probe') {
												if (
													...
													return;
												(r.priorWebsocketSuccess = u.name === 'websocket'),
			...
			(r.prototype.onOpen = function() {
				if (
					...
					for (let t = 0, e = this.upgrades.length; t < e; t++)
		...
		(function(e) {
			...
			t.exports = function(t) {
				let n = t.xdomain,
					...
					i = t.enablesXDR;
				try {
					if (typeof XMLHttpRequest !== 'undefined' && (!n || r))
	...
	function(t, e, n) {
		(function(e) {
				...
				try {
					...
					try {
						if (this.extraHeaders) {
							...
							for (const o in this.extraHeaders)
			...
			(i.prototype.hasXDR = function() {
				return (
					typeof e.XDomainRequest !== 'undefined' &&
							!this.xs &&
							this.enablesXDR
				);
			}),
		...
		(function(t) {
			...
			(e.decodePacket = function(t, n, r) {
				...
				var i = new Uint8Array(t),
					...
					s = f(t, 1);
				return (
					k && n === 'blob' && (s = new k([s])), { type: b[o], data: s }
				);
			}),
			(e.decodeBase64Packet = function(t, e) {
				...
				return e === 'blob' && k && (r = new k([r])), { type: n, data: r };
			}),
				...
				function r(t, n) {
					e.encodePacket(t, !0, !0, (t) => {
						...
						for (
							...
							a[o] = parseInt(s[o]);
						if (((a[s.length] = 255), k)) {
							const c = new k([e.buffer, a.buffer, t]);
							n(null, c);
						}
					});
				}
			...
			(e.decodePayloadAsBinary = function(t, n, r) {
				...
				for (var o = t, i = []; o.byteLength > 0; ) {
					for (
						var s = new Uint8Array(o), a = s[0] === 0, c = '', p = 1;
						s[p] !== 255;
						p++
					) {
		...
		(function(t, o) {
			!(function(i) {
				...
				function l(t) {
					...
					if (b > v) throw Error('Invalid byte index');
					if (b == v) return !1;
					if (((e = 255 & g[b]), b++, (128 & e) == 0)) return e;
					if ((224 & e) == 192) {
				...
				let y = typeof e === 'object' && e,
					m = (typeof t === 'object' && t && t.exports == y && t,
						typeof o === 'object' && o);
		...
		(function(e) {
			...
			(r.prototype.write = function(t) {
				...
				for (var o = t.length, i = 0, a = o; i < a; i++)
					!(function(t) {
						s.encodePacket(t, r.supportsBinary, (i) => {
	...
	function(t, e, n) {
		...
		(r.prototype.onopen = function() {
			if ((u('transport is open - connecting'), this.nsp !== '/'))
				if (this.query) {
					const t =
								o(this.query) === 'object' ? h.encode(this.query) : this.query;
